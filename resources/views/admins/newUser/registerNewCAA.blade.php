        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header ">
                    <h3 class="text-primary text-center"> {{ __('Register new CAA officer to the system') }} </h3>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname') }}" autocomplete="fname" autofocus>
                ...
                <div class="card-footer">
                    <a href="{{route('admin.newUser.newAirliner')}}" class="btn btn-link float-right"> New airline officer <i class="fas fa-user-plus"></i></a>
